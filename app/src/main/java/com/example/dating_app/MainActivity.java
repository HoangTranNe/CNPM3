...
import com.example.dating_app.chat.SendNotification;
...
import com.example.dating_app.Card.arrayAdapter;
import com.example.dating_app.Card.Card;
...
public class MainActivity extends AppCompatActivity {
    ...
    private com.example.dating_app.Card.arrayAdapter arrayAdapter;
    private int i;
    private  String tag;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayAdapter = new arrayAdapter(this, R.layout.item_card, rowItems );
        ...
        flingContainer.setFlingListener(new SwipeFlingAdapterView.onFlingListener() {
            ...
            public void onLeftCardExit(Object dataObject) {
                ...
                //Display a banner when no Card are available to display
                TextView tv = (TextView)findViewById(R.id.noCardBanner);
                if(rowItems.size() == 0) {
        ...
        usersDb.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                if (dataSnapshot.exists() && !dataSnapshot.getKey().equals(currentUId)) {
                    //Log.d("Cardearch", "getOppositeSex called");
