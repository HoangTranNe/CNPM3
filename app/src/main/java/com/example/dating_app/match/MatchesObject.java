...
import com.example.dating_app.UserObject.UserObject;
...
public class MatchesObject {
    ...
    public MatchesObject(String userId, String name, String profileImageUrl, String need, String give, String budget, String lastMessage, String lastSeen, String lastTimeStamp, String childId){
        this.userId= userId;
        this.name=name;
